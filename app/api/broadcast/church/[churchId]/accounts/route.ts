...
import { requireBroadcastPermissionOrThrow } from '@/lib/broadcast-perms';

/**
 * GET /api/broadcast/church/[churchId]/accounts
 * Get all church broadcast accounts
 */
export async function GET(
  ...
  try {
    ...
    console.error('Error fetching church broadcast accounts:', error);
    return NextResponse.json(
...
/**
 * POST /api/broadcast/church/[churchId]/accounts
 * Create a new church broadcast account
 */
export async function POST(
  ...
  try {
    ...
    console.error('Error creating church broadcast account:', error);
    return NextResponse.json(
