...
import { Users, Shield, User, Crown, MoreVertical, Bell, BellOff } from "lucide-react";

interface ParticipantManagementProps {
  participants: PrayerParticipant[];
  currentUserId?: string;
  currentUserRole?: "PARTICIPANT" | "MODERATOR" | "ADMIN";
  onPromote?: (participantId: string, newRole: "MODERATOR" | "ADMIN") => void;
  onDemote?: (participantId: string, newRole: "PARTICIPANT" | "MODERATOR") => void;
...
export function ParticipantManagement({
  ...
  const sortedParticipants = [...participants].sort((a, b) => {
    const roleOrder = { ADMIN: 0, MODERATOR: 1, PARTICIPANT: 2 };
