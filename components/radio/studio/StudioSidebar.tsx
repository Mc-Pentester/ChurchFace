...
import {
  LayoutDashboard, Radio, Calendar, Library, ListMusic, Podcast, Music, Users, Mic, Bot, Globe, FileText, Shield, AlertTriangle, MessageSquare, Radio as RadioIcon
} from "lucide-react";
...
const studioItems = [
  ...
  { key: "live", label: "Studio Live", icon: Radio },
  ...
  { key: "jingles", label: "Jingles", icon: Music },
...
const modItems = [
  ...
  { key: "stories", label: "Stories", icon: RadioIcon },
      ...
      <div className="mt-auto p-3 border-t border-[#252535]">
        <div className="flex items-center gap-2 bg-[#1a1a25] rounded-lg p-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] text-gray-500">Radio Chrétienne 24/7</span>
          </div>
        </div>
      </div>
    </aside>
