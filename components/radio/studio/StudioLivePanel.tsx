...
export default function StudioLivePanel({ radio, onUpdate }: StudioLivePanelProps) {
  ...
  return (
    <div className="space-y-4">
      {/* STATUS */}
      <div className={`rounded-xl p-4 text-center border-2 transition ${isLive ? "bg-red-950/40 border-red-600/50" : "bg-gray-800/40 border-gray-700"}`}>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {[
              ...
              <tr key={src.key} className="border-b border-gray-700/50 last:border-0">
