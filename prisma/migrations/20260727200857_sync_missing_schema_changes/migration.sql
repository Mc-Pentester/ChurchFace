/*
  ...
  - You are about to drop the column `hasHandRaised` on the `PrayerLiveParticipant` table. All the data in the column will be lost.
  - You are about to drop the column `isMuted` on the `PrayerLiveParticipant` table. All the data in the column will be lost.
  ...
  - A unique constraint covering the columns `[roomId,userId]` on the table `PrayerLiveParticipant` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "LiveBroadcast" ADD COLUMN     "rtmpUrl" TEXT,
...
-- AlterTable
ALTER TABLE "PrayerLiveParticipant" DROP COLUMN "hasHandRaised",
DROP COLUMN "isMuted";
...
-- AlterTable
ALTER TABLE "Radio" ALTER COLUMN "startedAt" DROP NOT NULL,
